...
public class MaLiLibGuiElementRendererRegistries {
    public static PictureInPictureRendererRegistration<MaLiLibBlockStateGuiElement> blockStateGuiElement() {
        return new PictureInPictureRendererRegistration<>(MaLiLibBlockStateGuiElement.class, MaLiLibBlockStateGuiElementRenderer::new);
    }
}
